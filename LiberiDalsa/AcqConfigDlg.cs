...
namespace DALSA.SaperaLT.SapClassGui
{
    ...
    public partial class AcqConfigDlg : Form
    {
        ...
        public AcqConfigDlg(SapLocation loc, string productDir, ServerCategory serverCategory, int ID_Cam)
        {
           m_ProductDir = productDir;
           m_ServerCategory = serverCategory;
            if (ID_Cam==0) { ID_Camera = "Master"; } else { ID_Camera = "Slave"; }
           if (loc != null)
           {
        ...
        public bool ClousedDialogOK() {     
            if (comboBox_configfile.Text != "") { 
                comboBox_Device.Text = "CameraLink Medium Color RGB";
                button_ok_Click(null, null); return true; }
               comboBox_Device.Text = "CameraLink Medium Color RGB";
        ...
        public bool ClousedDialogOK_RGB()
        {
            if (comboBox_configfile.Text != "")
            {
                comboBox_Device.Text = "CameraLink Medium Color RGB";
        ...
        public bool ClousedDialogOK_Mono()
        {
            if (comboBox_configfile.Text != "")
            {
                comboBox_Device.Text = "CameraLink Medium Color Mono";
                button_ok_Click(null, null); return true;
            }
            comboBox_Device.Text = "CameraLink Medium Color Mono";
        ...
        {
            String KeyPath = "Software\\Teledyne DALSA\\" + /*Application.ProductName*/ ID_Camera + "\\SapAcquisition";
